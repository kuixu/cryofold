...
from cryofold.model.primitives import Linear, LayerNorm, Attention
...
from cryofold.utils.checkpointing import checkpoint_blocks
from cryofold.utils.chunk_utils import (
    chunk_layer,
    ChunkSizeTuner,
)
...
class TemplatePointwiseAttention(pl.LightningModule):
    """
...
class TemplatePairStack(pl.LightningModule):
    """
