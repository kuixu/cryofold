...
class CryoFoldLRScheduler(torch.optim.lr_scheduler._LRScheduler):
    """ Implements the learning rate schedule defined in the CryoFold 2
    ...
    def __init__(self, 
        ...
        base_lr: float = 0.,
        max_lr: float = 0.001,
        warmup_no_steps: int = 10, # default: 1000
        ...
        super(CryoFoldLRScheduler, self).__init__(
            optimizer,
