...
def multi_head_attention_forward(
    ...
    if naive:
        ...
        if gaussian is not None:
            ...
            attn_output_weights = attn_output_weights + gaussian.view(bsz, 1, -1).repeat(num_heads, 1, 1)
        attn_ind = attn_output_weights.view(bsz, num_heads, tgt_len, src_len).argmax(-1)
